    ...
    switch (action) {
      ...
      case "kick":
        ...
        await global.reply(sock, msg, {
          text: `\`\`\`@${
            sender.split("@")[0]
          } has been kicked for sending links\`\`\``,
          mentions: [sender],
        });
        break;
      ...
      case "warn":
        ...
        if (warningCount >= WARN_COUNT) {
          ...
          await global.reply(sock, msg, {
            text: `\`\`\`@${
              sender.split("@")[0]
            } has been kicked after ${WARN_COUNT} warnings\`\`\``,
            mentions: [sender],
          });
        } else {
          await global.reply(sock, msg, {
