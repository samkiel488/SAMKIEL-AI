...
async function handleMessages(sock, messageUpdate, printLog) {
    try {
        ...
        const adminCommands = ['.mute', '.unmute', '.ban', '.unban', '.promote', '.demote', '.kick', '.tagall', '.antilink', '.mode'];
        ...
        if (isGroup && isAdminCommand) {
            ...
            if (!isBotAdmin) {
                await sock.sendMessage(chatId, { text: 'Sorry your name no dey for the owners list😞.', ...channelInfo });
                return;
            }
